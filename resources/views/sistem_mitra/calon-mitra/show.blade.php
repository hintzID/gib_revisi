    ...
    <div class="container border p-4 rounded border-dark">
        ...
        <div class="container border mt-4 mb-4 p-4 rounded">
            ...
            <div>
                ...
                <textarea name="alamat" id="alamat" rows="3" class="form-control" readonly>{{ $calonMitra->alamat }}</textarea>
            </div>
        ...
        <div class="container border mt-4 mb-4 p-4 rounded">
            ...
            <div>
                ...
                <input type="text" name="profesi" id="profesi" value="{{ $calonMitra->profesi }}" class="form-control"
                    readonly>
            </div>

            <div>
                <label for="alamat_pimpinan">Alamat Pimpinan:</label>
                <textarea name="alamat_pimpinan" id="alamat_pimpinan" rows="3" class="form-control" readonly>{{ $calonMitra->alamat_pimpinan }}</textarea>
            </div>

            <div>
                <label for="no_hp_pimpinan">No. HP Pimpinan:</label>
                <input type="text" name="no_hp_pimpinan" id="no_hp_pimpinan" value="{{ $calonMitra->no_hp_pimpinan }}"
                    class="form-control" readonly>
            </div>
            ...
            <div>
                ...
                <input type="number" name="jumlah_pengurus_menetap" id="jumlah_pengurus_menetap"
                    value="{{ $calonMitra->jumlah_pengurus_menetap }}" class="form-control" readonly>
            </div>
            ...
            <div>
                ...
                <input type="number" name="jumlah_pengurus_tidak_menetap" id="jumlah_pengurus_tidak_menetap"
                    value="{{ $calonMitra->jumlah_pengurus_tidak_menetap }}" class="form-control" readonly>
            </div>
        </div>
        ...
        <div class="container border mt-4 mb-4 p-4 rounded">
            ...
            <div>
                ...
                <input type="number" name="jumlah_yatim_piatu" id="jumlah_yatim_piatu"
                    value="{{ $calonMitra->jumlah_yatim_piatu }}" class="form-control" readonly>
            </div>
        ...
        <div class="container border mt-4 mb-4 p-4 rounded">
            ...
            <div>
                ...
                <input type="text" name="status_milik_tanah" id="status_milik_tanah"
                    value="{{ $calonMitra->status_milik_tanah }}" class="form-control" readonly>
            </div>
            ...
            <div>
                ...
                <textarea name="keterangan_fasilitas" id="keterangan_fasilitas" rows="3"
                    class="form-control" readonly>{{ $calonMitra->keterangan_fasilitas }}</textarea>
            </div>
